...
tr:{
 ...
 wifiFailGaveUp:'Wi‑Fi bağlanamadı (2 deneme). Kurtarma AP açık. SSID ve parolayı kontrol edip tekrar bağlanın.',
...
en:{
 ...
 wifiFailGaveUp:'Wi‑Fi could not connect (2 attempts). Recovery AP is on. Check SSID/password and retry from Setup.',
